...
while True:
    ...
    message_button = Button(text="upload", command=upload_file_to_server(sftp_client, file_upload , "remote_file"))
    message_button.pack()
